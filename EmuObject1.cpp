...
#define FH 32
	...
	case 4:
		{
			result=m_Display->Open(1280,1024,16,this->m_hWnd);
			wPlace.rcNormalPosition.right=wPlace.rcNormalPosition.left+1280+FW;
			wPlace.rcNormalPosition.bottom=wPlace.rcNormalPosition.top+1024+FH;
			break;
		}
	}
