...
extern void dynaBuildReadMap();
extern void dynaBuildWriteMap();

extern WORD dynaOpSmartSwc1(BYTE *cp,BYTE op0,BYTE op1,DWORD Imm,BYTE Page);
extern WORD dynaOpSmartSdc1(BYTE *cp,BYTE op0,BYTE op1,DWORD Imm,BYTE Page);
extern WORD dynaOpSmartLwc1(BYTE *cp,BYTE op0,BYTE op1,DWORD Imm,BYTE Page);
extern WORD dynaOpSmartLdc1(BYTE *cp,BYTE op0,BYTE op1,DWORD Imm,BYTE Page);
