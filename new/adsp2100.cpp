...
unsigned adsp2100_get_mstat(void)
{
	return adsp2100.mstat;
}

void adsp2100_set_imask(unsigned val)
{
	adsp2100.imask=val;
}
...
int adsp2100_execute(int cycles)
{
	...
	{
		UINT32 op, temp;
		//The R4600/TMS34010 sends a command at the beginning of the execution//
		//Stupid hack to fix that
/*
		if(dcs.GetDWORD(0x10010) == 0x1816EF20)
		{
...
#endif
		case 0xBEEF: return adsp2100.ppc;
		default:
